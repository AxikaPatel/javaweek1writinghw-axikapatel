...
public class Programme_1_BioData
{
    public static void main(String[] args)
    {
        ...
        System.out.println("Name          : Axika Patel");
        System.out.println("Mobile        : 07529591818");
        System.out.println("Email         : axikapatel@gmail.com");
        System.out.println("Gender        : Female");
        System.out.println("Date of Birth : 04.03.1987");
        System.out.println("Marital Status: Married");
        System.out.println("Languages     : English,Spanish and German");
